...
const renderTrainer = (trainerHash) => {
     ...
     div.setAttribute("class", "card") //div.setAttribute takes 2 arguments(attribute you want to create, value)
...
//preventDefault prevent the page from refreshing and something asynchronously will happen here
